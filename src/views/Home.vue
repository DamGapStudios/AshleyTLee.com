    ...
    <div id="app" class="center-stuff ashley-blue">
      ...
      <div class="app app-link">
        <a href='https://itunes.apple.com/us/app/ashley-t-lee/id998172757?ls=1&mt=8'>
          <img style='width: 135px; padding: 10px' class="app app-store" alt='Get it on the App Store' src='../assets/Download_on_the_App_Store_Badge_US-UK_135x40.svg'/>
        </a>
        ...
        <button class="about-button">Click to Download</button>
      </div>
    </div>
  </div>
</template>
