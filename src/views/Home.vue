    ...
    <div id="about">
      <div class="text-block">
        <div style="padding: 15px 0">
          <span style="font-weight: bold">Ashley T Lee</span> is a Christian Author and Speaker. She is currently featured on over 150 Christian radio stations across America
      ...
      <div class="photo">
        <img src="http://www.ashleytlee.com/wp-content/uploads/2017/06/ashley_portrait.png" class="portrait"/>
      </div>
    </div>
...
<style scoped>
  @media only screen and (min-width : 1160px) {
    ...
    .app-button:hover{
      background-color: #5CD1D6 !important;
